...
include { UMITOOLS_EXTRACT as UMITOOLS_EXTRACT_SE } from '../../../software/umitools/extract/main.nf' addParams( options: [publish_dir:'test_single_end' ] )
include { UMITOOLS_EXTRACT as UMITOOLS_EXTRACT_PE } from '../../../software/umitools/extract/main.nf' addParams( options: [publish_dir:'test_paired_end' ] )
